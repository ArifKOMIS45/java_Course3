 ...
 */
 public static void main(String[] args) {
    ...
    String secim="";
     do {
        System.out.print("Hangi hayvanı sahiplenmek istiyorsunuz?:");  secim=oku.nextLine();
        hayvan.tercihler(secim);
    }while (!secim.equalsIgnoreCase("kedi") &&!secim.equalsIgnoreCase("kopek"));
